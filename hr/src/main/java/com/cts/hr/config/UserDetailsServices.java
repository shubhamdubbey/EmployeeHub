...
public class UserDetailsServices implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        // Provide authorities in the format Spring expects: ROLE_<ENUM_NAME>
        String roleName = "ROLE_" + loginDetails.getRoles().name();
        return new User(loginDetails.getUsername(), loginDetails.getPassword(),
